import random
from models.db.functions import pull, update, get_sub_category, push
from models.domains import Customer, Order

push(
    Customer("C123", "Emmett Rogers", "+1 202-918-2132")
)
push(
    Order("O123", "C007", {'Vishay Dale IHD1EBR2R2L': 1}, "2021-10-22")
)

for re in pull("customer")[1]:
    print(re.get_all_info())

for re in pull("orders")[1]:
    print(re.get_all_info())
