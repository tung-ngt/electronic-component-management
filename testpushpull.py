...
def main():
    ...
    ic_num, ic_list = pull(table = 'ic', sort_option = [('mnf_id', 'desc'), ('price', 'asc')])
    updated = update('ic', change_value = [('price', '1')], change_place = [('guarantee', '1')])
    if updated == False :
        print('Update failed')
