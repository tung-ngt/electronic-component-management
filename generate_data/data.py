...
# abspath to models
import os, sys
sys.path.append(os.path.abspath(r'C:\Users\ciltr\Desktop\USTH\Semester 2\Python\Python project\electronic-component-management'))
...
for i in range(100):
    ...
    capacitor_samples.append(Capacitor(mnf_id, price, inventory_date, guarantee, part_number, sub_category, stock, capacitance))
...
for i in range(120):
    ...
    resistor_samples.append(Resistor(mnf_id, price, inventory_date, guarantee, part_number, sub_category, stock, resistance))
...
for i in range(120):
    ...
    inductor_samples.append(Inductor(mnf_id, price, inventory_date, guarantee, part_number, sub_category, stock, inductance))
...
for i in range(120):
    ...
    sensor_samples.append(Sensor(mnf_id, price, inventory_date, guarantee, part_number, sub_category, stock, sensor_type))
...
for i in range(120):
    ...
    ic_samples.append(IC(mnf_id, price, inventory_date, guarantee, part_number, sub_category, stock, clock))
