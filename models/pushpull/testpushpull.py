...
# Need to abspath to the path of the models folder
from os import path
import sys
path_to_models = path.abspath(r'C:\Users\ciltr\Desktop\USTH\Semester 2\Python\Python project\electronic-component-management')
sys.path.append(path_to_models)
from Pushpulltosql import pull
